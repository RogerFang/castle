...
public class MongodbConfigBean {
	...
	public MongoTemplate mongoTemplate() throws UnknownHostException {
		...
		MappingMongoConverter mappingMongoConverter = new MappingMongoConverter(defaultDbRefResolver, new MongoMappingContext());
	...
	public MongoDbFactory mongoDbFactory() throws UnknownHostException {
		return new SimpleMongoDbFactory(new MongoClient("localhost"), "whenling");
	}
